namespace Day_12
{
    ...
    internal class Program
    {
        static void Main1(string[] args)
        {
            ...
            //var res =employeeList.Sum(x => x.Salary);
            //Console.WriteLine(res);

            //var res =employeeList.Max(x => x.Salary);
            //Console.WriteLine(res);

            //var res =employeeList.Count();
            //Console.WriteLine(res);

            //var res= employeeList.Concat(employeeList);
            //foreach(Employee emp in res) { Console.WriteLine(emp.Id); }

            var res =employeeList.Distinct().ToList();
            foreach (Employee emp in res) { Console.WriteLine(emp.Id); }
        }
    }
}