...
namespace NewSampleForLog4Net
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var person1 = new PaPerson("Vikash", "Verma");
            var person2 = new PaPerson("Suresh", "Kumar");

            var car1 = new PaCar("Tesla Model S", 2020, person1);
            var car2 = new PaCar("Tesla Model X", 2020, person2);
